...
public class ShelfAdapter extends RecyclerView.Adapter<ShelfAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.imageView = view.findViewById(R.id.image_cover);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        holder.novelCover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ReadActivity.actionStart(view.getContext(), shelf.getRecentChapterUrl(), shelf.getId() ,shelf.getBookId());
            }
        });
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(holder.novelView).load(shelf.getBookCoverUrl()).into(holder.imageView);
    }
