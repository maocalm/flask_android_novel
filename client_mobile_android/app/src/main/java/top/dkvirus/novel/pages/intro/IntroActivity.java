...
public class IntroActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Integer novelClassId , novelId;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        novelClassId = intent.getIntExtra("novelClassId", 0);
     ...
     * 页面跳转传参
     */
    public static void actionStart(Context context, String novelUrl, int classfiyId, int novelId) {
        Intent intent = new Intent(context, IntroActivity.class);
        intent.putExtra("novelUrl", novelUrl);
        intent.putExtra("novelClassId", classfiyId);
...
//        if (novelClassId==1){
//        }
        shelf.setClassifyName(mNovel.getClassifyName());
        shelf.setLastUpdateAt(new Date());
        shelf.setUserId(userId);
        shelf.setBookId(novelId);
    ...
    private void handleSearchNovel (String novelUrl) {
        ...
        call.enqueue(new Callback<NovelVo>() {
            ...
            public void onFailure(Call<NovelVo> call, Throwable t) {
                ...
                Log.d(TAG, "onFailure: 请求小说详情失败  :" + t.getMessage());
            }
        });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (!IntroActivity.this.isDestroyed()) {
                    Glide.with(IntroActivity.this).load(novel.getBookCoverUrl()).into(imageViewCover);
                }
            }
        });
