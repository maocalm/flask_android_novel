...
public class ClassifyAdapter extends RecyclerView.Adapter<ClassifyAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        holder.classifyName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                clickClassfy.onClick(classify.getId());
    ...
    interface ClickClassfy {
        void onClick(int postion);
    }

    ClickClassfy clickClassfy;

    public void setOnClick(ClickClassfy classfy) {
        this.clickClassfy = classfy;
    }
}
