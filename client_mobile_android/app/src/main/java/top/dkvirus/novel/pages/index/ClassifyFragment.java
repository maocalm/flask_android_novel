...
public class ClassifyFragment extends Fragment  implements ClassifyAdapter.ClickClassfy {
    ...
    private void handleGetClassify () {
        ...
        call.enqueue(new retrofit2.Callback<ClassifyVo>() {
            ...
            public void onResponse(Call<ClassifyVo> call, final Response<ClassifyVo> response) {
                ...
                classifyList = response.body().getData();
                ...
                if (mainActivity != null) {
                    mainActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            classifyAdapter.setOnClick(ClassifyFragment.this);
    ...
    public void onClick(int postion) {
        handleGetNovelByClassifyId(classifyList.get(postion-1).getId());
    }
}
