...
public class ReadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int novle_id = intent.getIntExtra("novle_id", -1);
        shelfId = id;
        this.novle_id = novle_id;
     ...
     * 处理页面跳转
     */
    public static void actionStart(Context context, String chapterUrl, int id, int novle_id) {
        Intent intent = new Intent(context, ReadActivity.class);
        intent.putExtra("chapterUrl", chapterUrl);
        intent.putExtra("id", id);
        intent.putExtra("novle_id", novle_id);
